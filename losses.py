...
class compute_loss(nn.Module):
    ...
    # def forward_Depth(self, valid_mask_1, valid_mask_2, type, pred_list, coord_list, gt_depth):
    #     loss = 0.0
    #     cnt = 0
    #     for (pred, coord) in zip(pred_list, coord_list):
    #         if coord is None:
    ...
    #             if type == 'with_mask':
    #                 pred_depth = pred_depth[valid_mask_1]
    #                 pred_sigma = pred_sigma[:, 0, :, :][valid_mask_1]
    #                 loss_pixelwise = torch.log(pred_sigma) \
    #                                  + torch.square((pred_depth-gt_depth)/pred_sigma)/2
    #                 loss = loss + torch.mean(loss_pixelwise)
    ...
    #             if type == 'with_mask':
    #                 pred_depth = pred_depth[valid_mask_2[cnt]]
    #                 pred_sigma = pred_sigma[:, 0, :][valid_mask_2[cnt]]
